...
單線累積瓶頸能量圖將上臂限制時新增的STP記為負、軀幹限制時新增的STP記為正，再沿時間累加成唯一一條曲線。曲線往下表示該段新增STP偏上臂限制，往上表示偏軀幹限制；曲線本身仍低於零只代表從FP累積至當下的總帳仍偏上臂，不能拿曲線正負判斷當下限制端。曲線在FP–BR 69%降至最低後開始回升，表示此前新增STP主要仍偏上臂限制，此後新增STP轉為偏軀幹限制。最後持續交接中位在72.3%，MER中位77.1%（IQR 74.5–79.0%）。到BR時，上臂限制累積87.63 J、軀幹限制72.36 J，整段淨差仍偏上臂限制15.27 J；因此「後段由軀幹限制」與「全程累積仍略偏上臂限制」可同時成立。
